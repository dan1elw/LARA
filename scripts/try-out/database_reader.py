...
class LARAReader:
    ...
    def get_overview(self):
        ...
        print(
            f"Average Altitude:         {stats['avg_altitude']:.0f} m ({stats['avg_altitude'] * 3.28084:.0f} ft)"
        )
    ...
    def get_top_airlines(self, limit=10):
        ...
        print("=" * 70)
        print(
            f"{'Code':<6} {'Flights':<10} {'Avg Min Distance':<20} {'Avg Altitude':<15}"
        )
        print("-" * 70)
    ...
    def get_countries(self):
        ...
        for country in countries:
            print(
                f"{country['origin_country']:<25} {country['flight_count']:<12} {country['avg_min_distance']:>12.2f} km"
            )
    ...
    def get_closest_flights(self, limit=10):
        ...
        for flight in flights:
            callsign = flight["callsign"] or "N/A"
            altitude = (
                f"{flight['min_altitude_m']:.0f}m"
                if flight["min_altitude_m"]
                else "N/A"
            )
            position = (
    ...
    def get_daily_stats(self, days=7):
        ...
        print("=" * 70)
        print(
            f"{'Date':<12} {'Flights':<10} {'Avg Min Distance':<20} {'Avg Altitude':<15}"
        )
        print("-" * 70)
    ...
    def get_flight_route(self, flight_id):
        ...
        for pos in positions:
            ...
            speed = (
                f"{pos['velocity_ms'] * 3.6:.0f} km/h" if pos["velocity_ms"] else "N/A"
            )
