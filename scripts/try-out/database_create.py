...
class FlightDatabase:
    ...
    def add_position(self, flight_id, state, distance_km, timestamp):
        ...
        ''', (distance_km, distance_km, 
              state[7] or state[13], state[7] or state[13],
              state[7] or state[13], state[7] or state[13],
              flight_id))
...
def main():
    ...
    try:
        ...
        while True:
            ...
            print(f"[{datetime.now().strftime('%H:%M:%S')}] Scan #{iteration}...", end=" ")
            ...
            if flights:
                ...
                for distance, state in nearby_flights:
                    ...
                    # Store in database
                    flight_id = db.get_or_create_flight(icao24, callsign, origin_country, timestamp)
